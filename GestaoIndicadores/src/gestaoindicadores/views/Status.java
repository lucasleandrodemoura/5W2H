 ...
 * @author lucas
 */
public class Status extends javax.swing.JInternalFrame implements TelaVIEW {
    gestaoindicadores.controlers.Status obj;
    /**
    ...
    public void AlimentaTabela() {
        ...
        try {
            while (x.next()) {
                obj = new gestaoindicadores.controlers.Status(x.getInt("idstatus"), x.getString("descricao"), x.getBoolean("ativo"));
                model.addRow(new Object[]{"", "", "", ""});
                this.jTable.setValueAt(obj.getIdstatus(), contador, 0);
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if (this.jTable.getSelectedRow() == -1) {
            ...
            new StatusRecords(id).setVisible(true);
        }
